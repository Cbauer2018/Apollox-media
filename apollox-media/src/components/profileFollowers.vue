        ...
        <v-card flat>
          <v-card-text>
            <v-container>
             ...
             <v-layout justify-center><h1>Followers:</h1></v-layout>
             <v-layout justify-center column >
...
beforeCreate() {
    this.$store.dispatch('viewFollowers', {uid:this.$route.params.uid})
},

computed: {
   
      followerUsernames(){
          return this.$store.getters.loadedProfileFollowers;
      }
